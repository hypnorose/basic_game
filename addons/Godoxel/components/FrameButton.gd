...
@onready var frame_preview := find_child("TextureRect")
...
func update_preview():
	...
	for layer in frame.layers:
		...
		texture_rect.offset_left = 3
		texture_rect.offset_top = 3
		texture_rect.offset_right = -3
		texture_rect.offset_bottom = -3
